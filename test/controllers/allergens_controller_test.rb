...
class AllergensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create allergen" do
    assert_difference('Allergen.count') do
      post allergens_url, params: { allergen: { description: @allergen.description, name: @allergen.name } }
    end
  ...
  test "should update allergen" do
    patch allergen_url(@allergen), params: { allergen: { description: @allergen.description, name: @allergen.name } }
